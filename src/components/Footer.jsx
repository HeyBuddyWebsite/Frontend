        ...
        <div className="mx-auto lg:w-[90%] space-y-8 px-4 sm:px-6 lg:space-y-16 lg:px-10 relative z-10">
          <div className="grid grid-cols-1 pt-8 gap-16 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16 ">
            <div className="py-4">
              <div className="flex flex-col items-center lg:items-start  justify-between">
                ...
                <div className="">
                  ...
                  <ul className="mx-auto justify-center pt-4  lg:pt-16 flex lg:justify-start gap-6 sm:mt-0 sm:justify-end">
                    <li>
                      <a
            ...
            <div className="lg:py-4">
              <p className="font-bold text-white text-xl">Our Services</p>
            ...
            <div className="lg:py-4">
              <p className="font-bold text-white text-xl">Contact Information</p>
              <ul className="mt-6 space-y-2 text-xs">
          ...
          <p className=" text-center text-sm mx-auto border-t py-4 text-white">
            Copyright &copy; 2026. heybuddy.co.in | All Rights Reserved.
          </p>
        </div>
      </footer>
    </div>
