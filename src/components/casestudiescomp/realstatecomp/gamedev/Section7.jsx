...
const Section7 = ({ heading }) => {
  return (
    <div className="w-[100%] lg:w-[80%]  mb-8 md:mb-12 lg:mb-[130px] mx-auto bg-[url('https://heybuddystorage.blob.core.windows.net/s3-migratedheybuddy/Images/Ellipse%208%20(1).svg')] bg-no-repeat  bg-auto lg:bg-contain bg-[center_top_0rem]">
      <div className=" mx-auto w-[90%] lg:w-[100%] py-24 ">
