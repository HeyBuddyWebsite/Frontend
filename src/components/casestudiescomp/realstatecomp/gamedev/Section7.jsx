...
const Section7 = ({ heading }) => {
  return (
    <div className="bg-[url('https://heybuddystorage.blob.core.windows.net/s3-migratedheybuddy/Images/Ellipse7.png')] bg-no-repeat  bg-cover bg-[center_top_1rem]">
      <div className=" mx-auto lg:w-[80%] py-24 ">
        <div className="text-center">
          <p className=" px-4 lg:px-0 text-center mx-auto text-2xl lg:text-4xl font-bold sm:leading-8 text-white " style={{ whiteSpace: 'pre-line' }}>
            {heading} 
          </p>
