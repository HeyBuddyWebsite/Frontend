...
const Herosection = ({ handlecontactusModal }) => {
  ...
  return (
    <>
      ...
      >
        <p>
          Elevate your brand with Hey Buddy—AI advertising specialists delivering high-impact AI ads creative, personalized Facebook and Google ad creatives, and multi-format AI marketing creatives to boost your ROI. Experience seamless AI-powered advertising solutions tailored to your brand and campaign goals.
        </p>
      </div>
    </>
  );
