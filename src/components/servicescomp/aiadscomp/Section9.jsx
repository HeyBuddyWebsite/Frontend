...
const Bottomclient = () => {
  ...
  const clientcardData = [
    {
      ...
      name: "Marketing Director, Damilano",
    },
    {
      id: 2,
      name: "Brand Manager, Colorbar",
      content:
    ...
    {
      id: 3,
      name: "Marketing Head, Shivnaresh",
      content:
    ...
    {
      id: 5,
      name: "Marketing Manager, Kia Motors",
      content:
        "The AI ads by Heybuddy have been nothing short of amazing. The creativity, precision, and results delivered exceeded our expectations. Truly impressive output that added real value to our campaigns.",
    },
    {
      id: 6,
      name: "Brand Activation Manager, Nestlé",
      content:
        "Exceptional out-of-home campaigns and activation events. Brand visibility increased dramatically and consumer engagement exceeded all expectations.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div class=" pt-5 lg:py-12  grid mx-auto text-center justify-center rounded-xl shadow-sm sm:grid-1 md:mb-12 md:grid-cols-2 lg:grid-cols-2 gap-y-4 gap-x-4">
