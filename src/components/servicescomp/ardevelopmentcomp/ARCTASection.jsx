...
const ARCTASection = ({ handlecontactusModal }) => {
    return (
        <div className="py-16 px-6 lg:px-12">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-900 px-8 py-12 shadow-2xl lg:px-16 lg:py-20">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    >
                        Ready to Redefine Reality for Your Brand?
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Partner with the experts at Hey Buddy to create immersive AR experiences that engage, educate, and convert. Let&apos;s build something extraordinary together.
                    </motion.p>
                    <motion.button
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
