      ...
      <div className="sticky top-0 h-screen overflow-hidden flex items-center">
        ...
        <div className="relative z-20 px-6 lg:px-12 w-full max-w-7xl mx-auto flex flex-col items-center text-center mt-[-10vh] lg:mt-0">
          <h1 className="text-white text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight tracking-tight">
            The Trustworthy Augmented Reality <br /> Development Company
          </h1>

          <p className="text-gray-300 text-sm md:text-base lg:text-lg mb-8 leading-relaxed max-w-4xl">
            As a renowned Augmented Reality (AR) development company, Hey Buddy is a name you can trust. We have a solid reputation for delivering high-quality AR solutions that help brands connect with their audiences in innovative ways.
          </p>

          <div className="flex flex-wrap justify-center gap-4 mb-10">
            {[
              "Immersive AR Mobile Apps",
              "Interactive Brand Experiences",
              "Cutting-Edge Spark AR & Lens Studio"
            ].map((text, i) => (
