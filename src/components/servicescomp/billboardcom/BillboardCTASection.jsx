...
const BillboardCTASection = ({ handlecontactusModal }) => {
    return (
        <div className="py-16 px-6 lg:px-12">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-900 px-8 py-12 shadow-2xl lg:px-16 lg:py-20">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    >
                        Stop Traffic. Start Conversations.
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Ready to turn your next campaign into a viral 3D landmark? Partner with Hey Buddy to lead the anamorphic revolution. Let&apos;s build the future of advertising together.
                    </motion.p>
                    <motion.button
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Get Free 3D Billboard Strategy
                    </motion.button>
                </div>
            </div>
        </div>
...
export default BillboardCTASection;
