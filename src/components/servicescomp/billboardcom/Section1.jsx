    ...
    <div className=" w-[90%] lg:w-[80%] mx-auto mb-8 md:mb-12 lg:mb-[100px] ">
      <div style={containerStyle} className="">
        <div style={textContainerStyle}>
          <h1 className=" lg:w-[80%]    text-center mx-auto text-2xl lg:text-5xl font-bold  lg:font-bold" style={{whiteSpace: 'normal'}}>Captivates attention that stops time with 3D Billboard Development</h1>
