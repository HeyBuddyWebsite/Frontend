...
const stats = [
    {
        icon: FaChartLine,
        value: "$54B+",
        label: "projected global custom software market by 2025",
    },
    {
        icon: FaRocket,
        value: "30%",
    ...
    },
    {
        icon: FaBrain,
        value: "95%",
        label: "of enterprises will invest in AI-integrated software by 2025",
    },
    {
        icon: FaCloud,
        value: "61%",
        label: "market share for cloud-native custom solutions",
    },
    {
        icon: FaCogs,
        value: "ROI",
        label: "proven 5-10% return in the first year of deployment",
    },
    {
        icon: FaShieldAlt,
        value: "100%",
        label: "ownership and control over your digital infrastructure",
    },
];

const CustomSoftwareOpportunitySection = () => {
        ...
        >
            <div className="py-2 mb-2 text-white">
                <h2 className="lg:w-[90%] text-2xl lg:text-4xl font-bold mb-3 text-white">
                    Bespoke Software: The Engine of <br />
                    Enterprise Transformation
                </h2>
                <p className="text-gray-400 text-base lg:text-lg leading-relaxed max-w-4xl">
                    In a rapidly shifting digital economy, off-the-shelf software often creates bottlenecks. Custom software isn&apos;t just a tool—it&apos;s a competitive advantage. We build scalable, AI-integrated, and cloud-native solutions designed to eliminate inefficiency, secure your data, and scale with your vision.
                </p>
            </div>
...
export default CustomSoftwareOpportunitySection;
