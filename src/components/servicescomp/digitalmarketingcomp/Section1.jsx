...
const Herosection = ({ handlecontactusModal }) => {
  ...
  return (
    <>
      <div style={containerStyle}>
        <div style={textContainerStyle}>
          <h1 className=" text-3xl md:text-5xl">
            Hey Buddy, India's Leading Creative Digital
          </h1>
          <h1 className=" text-3xl md:text-5xl">Marketing Services Provider</h1>
          <Button
            style={buttonHeader}
      ...
      >
        <p>
          100+ clients. 100M+ views. Countless iconic campaigns. That's how Hey Buddy became India's #1 creative digital marketing Company.
        </p>
      </div>
    </>
  );
