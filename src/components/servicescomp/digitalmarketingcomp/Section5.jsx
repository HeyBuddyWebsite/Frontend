...
const Timelinecomp = () => {
    ...
    >
      <div className="py-4 mb-10 text-white">
        <h2 className="lg:w-[90%] text-2xl lg:text-4xl font-bold mb-6">
          Our Digital Marketing Process: <br />
  ...
  },
  {
    ...
    "desc": "Staying true to our collaborative approach toward digital marketing development, we welcome your feedback and suggestions in this step. Accordingly, we make necessary revisions so that your input shapes the final product, guaranteeing satisfaction."
  },
  {
    "title": "Quality Assurance",
    "desc": "Before we finally deliver, the resulting digital marketing campaigns undergo rigorous quality checks to ensure that our digital marketing meet your project standards. We deliver polished, error-free digital marketing that meet your project's visual and functional needs."
  },
  {
    "title": "Timely Delivery",
    "desc": "With our unwavering commitment, we deliver your digital marketing with high regard to timelines. We ensure this by utilizing our reliable development process and high professionalism, the two most essential ingredients for your project's success."
  }
].map((item, i) => (
