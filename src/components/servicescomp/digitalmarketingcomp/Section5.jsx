    ...
    >
      <div className="py-8 text-white">
        ...
        <p className=" text-base md:text-lg lg:text-2xl">
          Project after project, we have refined our digital marketing process to
                ...
                <div className="container text-white">
                  <ul>
                    ...
                    <li>
                      ...
                      <p>
                        Staying true to our collaborative approach toward digital marketing
                    ...
                    <li>
                      ...
                      <p>
                        Before we finally deliver, the resulting digital marketing campaigns
                        undergo rigorous quality checks to ensure that our digital marketing
                        meet your project standards. We deliver polished,
                        error-free digital marketing that meet your project's visual and
                        functional needs.
                      </p>
                    </li>
                    ...
                    <li>
                      ...
                      <p>
                        With our unwavering commitment, we deliver your digital marketing
