            ...
            <div className="sticky top-0 h-screen overflow-hidden flex items-center">
                ...
                <div className="relative z-20 px-6 lg:px-12 w-full max-w-7xl mx-auto flex flex-col items-center text-center">
                    <h1 className="text-white text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight tracking-tight">
                        Robotics Lab Setup <br className="hidden md:block" /> for Educational Excellence
                    </h1>

                    <p className="text-gray-300 text-sm md:text-base lg:text-lg mb-8 leading-relaxed max-w-4xl">
                        We build future-ready robotics labs that empower students to design, build, and program autonomous machines. From modular kits to advanced AI-integrated robotics, we provide a complete ecosystem for hands-on STEM learning that meets global educational standards.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-10">
                        <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
                            ...
                            <span className="text-white text-xs md:text-sm font-medium">Custom Lab Design & Setup</span>
                        </div>
                        <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
                            <AiFillCheckCircle className="w-5 h-5 text-white" />
                            <span className="text-white text-xs md:text-sm font-medium">K-12 Aligned & Certified Curriculum</span>
                        </div>
                        <div className="flex items-center space-x-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
                            <AiFillCheckCircle className="w-5 h-5 text-white" />
                            <span className="text-white text-xs md:text-sm font-medium">Comprehensive Teacher Training Workshops</span>
                        </div>
                    </div>
