...
const RoboticsCTASection = ({ handlecontactusModal }) => {
            ...
            >
                ...
                >
                    <h2 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-6 lg:mb-8 max-w-4xl mx-auto">
                        Ready to Build a World-Class Robotics Lab?
                    </h2>
                    <p className="text-white text-lg md:text-xl lg:text-2xl mb-8 lg:mb-12 max-w-3xl mx-auto leading-relaxed">
                        Partner with us to inspire the next generation of engineers. Let's design a robotics lab that fits your vision and budget.
                    </p>
...
export default RoboticsCTASection;
