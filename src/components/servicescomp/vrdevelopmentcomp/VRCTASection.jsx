...
const VRCTASection = ({ handlecontactusModal }) => {
    return (
        <div className="py-16 px-6 lg:px-12">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-600 to-indigo-900 px-8 py-12 shadow-2xl lg:px-16 lg:py-20">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    >
                        Ready to Build Your Own Virtual Universe?
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Partner with Hey Buddy to create world-class VR experiences that transform how you train, sell, and engage. Let&apos;s start your VR journey today.
                    </motion.p>
                    <motion.button
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
