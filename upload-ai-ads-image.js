...
const IMAGE_PATH = '/Users/vipulsharma/.cursor/projects/Users-vipulsharma-Documents-Documents-Vipul-s-Mac-mini-HeyBuddy-Frontend-main-2/assets/wp2034570_1-406b7f9a-a9f1-4db4-a71b-6f8cd6bf7a91.png';
...
async function main() {
  ...
  try {
    ...
    // Save result to file
    fs.writeFileSync('upload-ai-ads-image-result.json', JSON.stringify({ [path.basename(IMAGE_PATH)]: url }, null, 2));
    console.log('\n✅ Result saved to upload-ai-ads-image-result.json');
  } catch (error) {
