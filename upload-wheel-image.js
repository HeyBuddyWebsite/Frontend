...
const IMAGE_PATH = '/Users/vipulsharma/.cursor/projects/Users-vipulsharma-Documents-Documents-Vipul-s-Mac-mini-HeyBuddy-Frontend-main-2/assets/wheel-unscreen-ed1d56ee-1731-4d23-b3ec-e939eb5856cb.png';
...
async function main() {
  ...
  try {
    ...
    // Save result to file
    fs.writeFileSync('upload-wheel-result.json', JSON.stringify({ [path.basename(IMAGE_PATH)]: url }, null, 2));
    console.log('\n✅ Result saved to upload-wheel-result.json');
  } catch (error) {
